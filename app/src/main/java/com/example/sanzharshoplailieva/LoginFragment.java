package com.example.sanzharshoplailieva;
...
import com.example.sanzharshoplailieva.databinding.FragmentLoginBinding;
import com.example.sanzharshoplailieva.models.CurrentUser;
import com.example.sanzharshoplailieva.models.LoginResponse;
import com.example.sanzharshoplailieva.remote_data.RetrofitClient;
            ...
            response.enqueue(new Callback<LoginResponse>() {
                ...
                public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        navController.navigate(R.id.action_login_to_navigation_home, bundle);
                    }
                }
//                @Override
//                public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
...
//                            prefLoginEdit.putString("email",emailUserIdentify);
